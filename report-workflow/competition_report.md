...
| 模块 | 接线方式 | 验证状态 |
|------|---------|:---:|
| SHT31 | I2C1 (PB8/PB9)，共享总线 | ✅ 24-25°C / 47-51% |
...
- **SHT31**：I2C读取真实温湿度数据（24-25°C, 47-51%）已验证
...
publish {"temp":24,"hum":49,"lat":31,"lon":121,"gps_valid":1} (72 bytes)
```

#### SHT31 温湿度

```
[I2C] SHT31 sample T=25C H=47%
