...
> ⚠️ **此文件为项目初期的分工提案，已于 2026-07-07 归档。**
> - 当前正式分工见 [`CLAUDE.md`](../../CLAUDE.md)（任务架构 + 接口规范）
> - 当前开发计划见 [`doc-workflow/task2.md`](../task2.md)（硬件集成阶段）
> - Git 协作规范见 [`doc-workflow/GIT_WORKFLOW.md`](../GIT_WORKFLOW.md)
>
> **保留价值**：A/B/C 分工思路、接口规范理念。**不要当成当前状态。**
