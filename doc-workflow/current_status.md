...
| **Air780E (4G)** | `air780e/air780e.c` | ⚠️ 代码就绪 | HAL UART 真 AT 实现，等 PB0 PWRKEY 解决后硬件验证 |
| **Air780E MQTT** | `air780e/mqtt.c` | ⚠️ 代码就绪 | 真 UART MQTT AT 路径，等 PB0 解决 |
...
| 引脚 | 功能 | 状态 | 说明 |
|------|------|------|------|
| PB0 | LD1_GREEN GPIO_Output | ⚠️ 已配 | **仍为心跳灯，与 Air780E PWRKEY 冲突** |
...
1. **PB0 引脚冲突** — 仍为 LD1_GREEN 心跳灯，Air780E PWRKEY 未定义。B 组 4G 模块无法上电验证（Task 2.6 未开始）
...
- **Task 2.6 PB0 冲突解决**（最高优先级）→ Air780E/MQTT 才能上电验证
